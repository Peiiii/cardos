import { SmartCard, SmartCardQueryParams, SmartCardCreateParams, SmartCardUpdateParams } from '../../types/smart-card';
...
class CardService {
  ...
  async relateCards(sourceId: string, targetId: string): Promise<void> {
    ...
    // 如果已经关联，则无需操作
    if (sourceRelatedIds.includes(targetId) && targetRelatedIds.includes(sourceId)) {
      return;
    }
...
// 导出所有需要的类型
export type { SmartCard, SmartCardQueryParams, SmartCardCreateParams, SmartCardUpdateParams } from '../../types/smart-card'; 